...
<body>
                  ...
                  <tr>
                    <td>
                      <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                        <tbody>
                          <tr>
                            <td align="left"> <img src="https://i.postimg.cc/TPRtcxVn/985px-Laravel-svg.png" width="32"
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td
                              ...
                              <small>{{
                                App\Models\Order::where('orderId',$orderId)->first()->created_at->format('d-M-Y')
                                }}</small>
                            </td>
                          </tr>
                        </tbody>
  ...
  <!-- Total -->
  @php
  $info = App\Models\Order::where('orderId',$orderId)->get();
  @endphp
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable" bgcolor="#e1e1e1">
    <tbody>
      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td
                          ...
                          width="80">
                          {{ $info->first()->subTotal }} TK
                        </td>
                      </tr>
                      @if ($info->first()->discount)
                      <tr>
                        <td
                          style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                          Discount
                      ...
                      <tr>
                        ...
                        <td
                          style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                          <strong> {{ $info->first()->total }} TK</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                            @php
                            $billingInfo = App\Models\BillingDetail::where('orderId',$orderId)->get();
                            @endphp
                            <tbody>
                              <tr>
                                <td
                              ...
                              <tr>
                                <td
                                  ...
                                  Name : {{ $billingInfo->first()->name }},<br>
                                  Mobile : {{ $billingInfo->first()->mobile }},<br>
                                  {{ $billingInfo->first()->address }},<br>
                                  {{ $billingInfo->first()->relToCity->name }},
                                  <br>
                                  {{ $billingInfo->first()->relToCountry->name }}
                                </td>
                              </tr>
                            </tbody>
                          </table>
