					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						...
						<div class="card chat dz-chat-history-box d-none">
							<div class="card-header chat-list-header text-center">
								...
								<div class="dropdown">
									<a href="javascript:void(0)" data-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg"
											xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24"
											version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="{{ route('productVariation') }}">Add Product Variation</a></li>
							<li><a href="{{ route('viewProduct') }}">Product List</a></li>
						</ul>
					</li>
					@endcan
					@can('coupon.delete')
					...
					@endcan
					@can('order.delete')
					<li><a class="has-arrow ai-icon" href="{{ route('customerOrder') }}" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{ route('create.user.role') }}" aria-expanded="false">Assign a Role For User</a>
							</li>
							<li><a href="{{ route('create.permission') }}" aria-expanded="false">Create
									Permission</a>
							</li>
							<li><a href="{{ route('create.assign.role') }}" aria-expanded="false">Create & Assign
									Role</a>
							</li>
						</ul>
					</li>
